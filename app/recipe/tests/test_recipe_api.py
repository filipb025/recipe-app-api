...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        ...
        other_user = create_user(email='other@examole.com', password='test123')
    ...
    def test_recipe_other_users_recipe_error(self):
        """ Test removing a recipe from other user gives error """
        new_user = create_user(email='user@example.com', password='test123')
    ...
    def test_update_recipe_assign_tag(self):
        """ Test assigning tag to recipe when updating recipe """
